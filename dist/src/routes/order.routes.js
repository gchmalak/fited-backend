...
import { createOrder, getAllOrders, getMyOrders, getOrder, updateOrderStatus, } from "../controllers/orders.controller.js";
...
orderRouter
    ...
    .put(CheckAuth, isAdmin, validateParamsSchema(idParamsSchema), validateBodySchema(updateOrderStatusSchema), updateOrderStatus);
