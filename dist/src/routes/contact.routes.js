...
import { createContactMessage, getAllContactMessages, markAsRead, replyToContactMessage, getMyContactMessages, customerReplyToContactMessage, } from "../controllers/contact.controller.js";
const contactRouter = Router();
//  Customer - Create a new conversation
contactRouter.post("/", validateBodySchema(createContactMessageSchema), createContactMessage);
//  Admin / Owner - Get all conversations
contactRouter.get("/", CheckAuth, isAdmin, getAllContactMessages);
//  Customer - Get their conversations
contactRouter.get("/my", CheckAuth, getMyContactMessages);
...
contactRouter.post("/:id/customer-reply", CheckAuth, validateParamsSchema(idParamsSchema), validateBodySchema(replySchema), customerReplyToContactMessage);
