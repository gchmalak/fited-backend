...
authRouter.put("/password", CheckAuth, validateBodySchema(changePasswordSchema), changePassword);
authRouter.post("/forgot-password", validateBodySchema(forgotPasswordSchema), forgotPassword);
authRouter.post("/reset-password", validateBodySchema(resetPasswordSchema), resetPassword);
authRouter.put("/profile-picture", CheckAuth, updateProfilePicture);
