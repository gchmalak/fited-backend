...
export async function getWishlist(req, res, next) {
    try {
        ...
        successResponse(res, user.wishlist, "Wishlist retrieved successfully", StatusCodes.OK);
    }
    catch (error) {
        next(error);
    }
...
export async function addToWishlist(req, res, next) {
    try {
        ...
        if (typeof id !== "string" || !Types.ObjectId.isValid(id)) {
            errorResponse(res, "Invalid product ID", StatusCodes.BAD_REQUEST);
            return;
        }
        ...
        successResponse(res, user.wishlist, "Product added to wishlist", StatusCodes.OK);
    }
    catch (error) {
        next(error);
    }
...
export async function removeFromWishlist(req, res, next) {
    try {
        ...
        successResponse(res, user.wishlist, "Product removed from wishlist", StatusCodes.OK);
    }
    catch (error) {
        next(error);
    }
